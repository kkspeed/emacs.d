...
(defvar yas-keymap  (let ((map (make-sparse-keymap)))
                      (define-key map [(shift tab)]       'yas-next-field-or-maybe-expand)
                      ;(define-key map (kbd "C-TAB")   'yas-next-field-or-maybe-expand)
                      ;(define-key map [(shift tab)] 'yas-prev-field)
                      (define-key map [backtab]     'yas-next-field-or-maybe-expand)
...
(defun yas--init-minor-keymap ()
  ...
  (let ((map (make-sparse-keymap)))
    ...
    ;;
    (define-key map [(shift tab)]     'yas-expand)
    (define-key map [backtab]         'yas-expand)
